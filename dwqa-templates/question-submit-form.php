...
<?php if ( dwqa_current_user_can( 'post_question' ) ) : ?>
	...
	<form method="post" class="dwqa-content-edit-form" enctype="multipart/form-data">
		...
		<p><?php dwqa_custom_tinymce_editor( array( 'content' => $content, 'textarea_name' => 'question-content', 'id' => 'question-content' ) ) ?></p>
		...
		<p class="hidden">
			...
			<input type="email" class="" name="_dwqa_anonymous_email" value="<?php echo 'dummy@dummyaddress.info' ?>" >
		</p>
		<p>
