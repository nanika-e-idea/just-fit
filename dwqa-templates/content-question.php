...
<div class="<?php echo dwqa_post_class(); ?>">
	...
	<p class="dwpa-question-content"><?php the_content(); ?></p>
	...
	<div class="dwqa-question-stats">
		...
		<span class="dwqa-votes-count" data-nonce="<?php echo wp_create_nonce( '_dwqa_question_vote_nonce' ) ?>" data-post="<?php the_ID(); ?>">
